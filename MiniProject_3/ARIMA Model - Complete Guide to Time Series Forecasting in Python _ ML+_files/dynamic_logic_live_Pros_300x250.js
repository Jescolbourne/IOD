    ...
    (function() {
        ...
        this.generateGallery = function(result,creativeVariationReporting,customWidgetReporting) {
            ...
            switch (dynamicData['campaignProperties:campaignProperties.creativeDim']) {
                case '300x250':
                    var imageContainerWidth = 235,
                        imageContainerHeight = 115,
                        imageBottom = 90,
                        imageTop = 40,
                        actualHeightLess = 110,
                        setTop = 55,
                        ftw_titleChar = 25;
                        app_titleChar = 10;
                        creativeDim = "300x250";
         ...
         //       colorReporting.push(color_code_val);
          ...
          //      product_colorReporting.push(result[i]['ID']+":"+color_code_val);
                ...
                if(result[i]['model_type'] == 'Footwear'){
                    ...
                    document.getElementsByClassName("head")[i].innerHTML = dynamicData['NC_Head_Three'][0]['Headline'];
                    document.getElementsByClassName("cta")[i].innerHTML = dynamicData['NC_Head_Three'][0]['CTA'];
                    var mac = "Mac";
                    ...
                    document.getElementsByClassName('product')[i].style.cssText += "width:300px;height:auto;top:-5px;"
                    document.getElementsByClassName("offer_head")[i].innerHTML = dynamicData['NC_Head_Three'][0]['Headline_2'];
                    document.getElementsByClassName("cta")[i].innerHTML = dynamicData['NC_Head_Three'][0]['CTA'];
                    var mac = "Mac";
                    if(navigator.userAgent.indexOf(mac) > -1)
                    {
                ...
                if(priority == "RecentConverter"){
                    ...
                    strategy = "RETARGETING|BEST.SELLER";
                    default_strategy = "NA|NA";
                }else if(priority == "LineItemIds"){
                    strategy = "PROSPECTING|BEST.SELLER";
                    default_strategy = "NA|NA";
                }else if(priority == "GeoLanguageDefault"){
                    strategy = "NA|NA";
                    default_strategy = "DEFAULT|FALLBACK.DEFAULT";    
                }else if(priority == "BaseDefault"){
                    strategy = "NA|NA";
                    default_strategy = "DEFAULT|MAIN.DEFAULT";
                }else{
                    strategy = "NA|NA";
                    default_strategy = "NA|NA";
                }
                ...
                if(ap_geoLang != "NA"){
                    geoValue = ap_geoLang.split("_")[0].replace(" ",".");
                ...
                var creativeTypeValue = {
                    3:"Mobile.Standard",
                    18:"IAB.Leaderboard",
                    19:"IAB.Wide.Skyscraper",
                    20:"IAB.Medium.Rectangle",
                    21:"IAB.Rectangle",
                    22:"IAB.Half.Page",
                    29:"IAB.Billboard.Non-Expanding"
                }
                ...
                var asv_values = {
                    ...
                    mindSetValue:"NA",
                    promotionVal:"NA",
                    abTestVal: parent.dynamicJSONData['selected-rule'] == "Prospecting_OLD_AB" ? "AB-OLD.template" : "OLD.Template"
                }
                 var assetVariantReportValues = strategy+"|"+geoValue+"|"+langValue+"|"+asv_values["dspValue"]+"|"+asv_values["deviceValue"]+"|"+asv_values["creativeType"]+"|"+asv_values["creativeSize"]+"|"+asv_values["videoValue"]+"|"+cat_Reporting.join(",")+"|"+gen_Reporting.join(",")+"|"+asv_values["dvLineitemID"]+"|"+asv_values["dvAuctionID"]+"|"+asv_values["dvCreativeID"]+"|"+asv_values["dvSiteID"]+"|"+asv_values["cmPID"]+"|"+asv_values["cmAdID"]+"|"+asv_values["cmRenderID"]+"|"+asv_values["cmCreativeID"]+"|"+asv_values["cmSiteID"]+"|"+asv_values["otherDSPLineID"]+"|"+asv_values["otherDSPAuctionID"]+"|"+asv_values["otherDSPCreativeID"]+"|"+asv_values["otherDSPRefsiteTag"]+"|"+asv_values["otherDSPAID"]+"|"+productReporting.join(',')+"|"+colorReporting.join(",")+"|"+cv_no+"|"+asv_values["dspProductModelType"]+"|"+modeltypeReporting.join(",")+"|"+default_strategy+"|"+asv_values["messageID"]+"|"+asv_values["mindSetValue"]+"|"+asv_values["promotionVal"]+"|"+asv_values["abTestVal"];
            ...
            if(result[0]['SpecialChar_3'] == "YES"){
                document.getElementsByClassName('intro_text')[0].style.cssText += "line-height:44px";
            }
            if(ap_DataSignal7 == "greece_greek")
            {
                document.getElementsByClassName('intro_text')[0].style.cssText +="font-size:40px;word-spacing: -4.5px;line-height: 35px;"; 
            } 
            if(ap_DataSignal7 == "russia_russian"){
                document.getElementsByClassName('intro_text')[0].style.cssText +="font-size:35px;word-spacing: -3.5px;line-height: 36px;";  
            }
            ...
            if(ap_DataSignal7 == "germany_german" || ap_DataSignal7 == "luxembourg_german" || ap_DataSignal7 =="switzerland_german"  ||  ap_DataSignal7 =="belgium_german" || ap_DataSignal7 == "austria_german"){
                document.getElementsByClassName('intro_text')[0].style.cssText += "font-size:40px;line-height:42px";
            } 
            if(ap_DataSignal7 == "slovakia_english"){
                document.getElementsByClassName('intro_text')[0].style.cssText += "font-size:39px;line-height:41px";
            }
                    ...
                    if((typeof dynamicData != "undefined") && (typeof dynamicData['NC_LABEL_FD'] != "undefined") && (dynamicData['NC_LABEL_FD'].length >= 1)){
                        ...
                        if(sale_percentage_final >= 5){
                            if(label_val_pos == 'Front'){
                                ...
                                document.getElementsByClassName('sale_corner')[i_].style.cssText += "font-size:11px;line-height:11px";
                                ...
                                document.getElementsByClassName('sale_corner')[i_].style.cssText += "font-size:16px";
                               // document.getElementsByClassName('sale_push')[i_].style.cssText += "padding-top:9px";
                            }
                            if(label_val.length>=5){
                              //  document.getElementsByClassName('sale_push')[i_].style.cssText += "right:5px";
                                 ...
                                 $(el).css('line-height', elNewLineHeight);
                            }
                        }
                    }else{
